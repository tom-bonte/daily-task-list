...
- Clicking the day timeline opens `renderDayZoom` in the `#sheet` dialog: an hour grid where overlapping sessions are packed into lanes side by side, and a block click opens that task.
